...
webLogFileFormat=configProps.get("web.log.file.format")
webLogFileFields=configProps.get("web.log.file.fields")
...
print 'webLogFileFormat=', webLogFileFormat
print 'webLogFileFields=', webLogFileFields
...
if not listonly:
    cmo.setRotationType(rotationType)
    cmo.setFileCount(int(rotationCount))
    cmo.setLogFileFormat(webLogFileFormat)
    cmo.setELFFields(webLogFileFields)
