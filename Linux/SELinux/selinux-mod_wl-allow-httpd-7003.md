...
- **Platform:** A reverse proxy/load balancer server running RHEL9 (or compatible)
- **SELinux status:** Enforcing
- **Service:** Apache httpd (`/usr/sbin/httpd`) with Oracle WebLogic plugin DSO (`mod_wl.so`)
